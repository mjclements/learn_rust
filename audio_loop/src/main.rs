...
fn main() -> Result<(), coreaudio::Error> {
    ...
    let mut custom_audio_unit =
        AudioUnit::new(IOType::GenericOutput).expect("Could not create Audio Unit");
    AudioUnit::initialize(&mut custom_audio_unit);
